<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:94:"/Applications/XAMPP/xamppfiles/htdocs/ut-lygbgl/public/../application/admin/view/admin/add.htm";i:1524116975;s:95:"/Applications/XAMPP/xamppfiles/htdocs/ut-lygbgl/public/../application/admin/view/public/top.htm";i:1524117020;s:96:"/Applications/XAMPP/xamppfiles/htdocs/ut-lygbgl/public/../application/admin/view/public/left.htm";i:1524117019;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('admin/add'); ?>" method="post">
                            ...
                            <div class="col-sm-6">
                                <select name="group_id">
                                    <?php if(is_array($authGroupRes) || $authGroupRes instanceof \think\Collection): $i = 0; $__LIST__ = $authGroupRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$authGroupRes): $mod = ($i % 2 );++$i;?>
                                       <option <?php if(($authGroupRes['title']=="个人")): ?> selected="selected" <?php endif; ?>  value="<?php echo $authGroupRes['id']; ?>"><?php echo $authGroupRes['title']; ?></option>
                        ...
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">工号</label>
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="worknum"  type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                         <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right" type="password">密码</label>
                            <div class="col-sm-6">
                      ...
                      <div class="col-sm-6">
                        <select name="type" style="width: 100%;">
                          ...
                          <option value="科级干部">科级干部</option>
                          <option value="普通教职工">普通教职工</option>
                        </select>
                      </div>
                    	</div>
                    <div class="form-group">
                      <label for="group_id" class="col-sm-2 control-label no-padding-right">部门</label>
                      <div class="col-sm-6">
