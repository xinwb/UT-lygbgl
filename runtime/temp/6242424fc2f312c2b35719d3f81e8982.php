<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:101:"/Applications/XAMPP/xamppfiles/htdocs/ut-lygbgl/public/../application/admin/view/summary/gerenlst.htm";i:1524117022;s:95:"/Applications/XAMPP/xamppfiles/htdocs/ut-lygbgl/public/../application/admin/view/public/top.htm";i:1524117020;s:96:"/Applications/XAMPP/xamppfiles/htdocs/ut-lygbgl/public/../application/admin/view/public/left.htm";i:1524117019;}*/ ?>
<!DOCTYPE html>
<!--总体的列表页-->
<html>
<head>
  ...
  <div class="tpl-content-wrapper"> 
    ...
    <div class="row">
      <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget1">
          <div class="widget-header bordered-bottom bordered-blue"> <span class="widget-caption">汇总</span> </div> 
            ...
            <div id="horizontal-form">
              <table class="table table-bordered  table-hover table-condensed text-center">
                ...
                <tr>
                  ...
                  <td align="center"><a href="<?php echo url('summary',array('id'=>$art['id'])); ?>" class="btn btn-primary btn-sm shiny"> <i class="fa fa-edit"></i> 汇总 </a> 
                    </td>
                    </label>
                </tr>
