<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:97:"/Applications/XAMPP/xamppfiles/htdocs/ut-lygbgl/public/../application/admin/view/checkgl/lst2.htm";i:1524117005;s:95:"/Applications/XAMPP/xamppfiles/htdocs/ut-lygbgl/public/../application/admin/view/public/top.htm";i:1524117020;s:96:"/Applications/XAMPP/xamppfiles/htdocs/ut-lygbgl/public/../application/admin/view/public/left.htm";i:1524117019;}*/ ?>
<!DOCTYPE html>
<!--进阶的候选人员分类页-->
<html>
<head>
  ...
  <div class="tpl-content-wrapper"> 
    ...
    <div class="row">
      <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget1">
          <form class="form-horizontal" role="form" action="<?php echo url('lst2'); ?>" method="post" enctype="multipart/form-data">
            <div class="widget-header1 bordered-bottom bordered-blue">
             <div class="chazhaojz"><span class="widget-caption">请选择要选取的对象群:</span></div>
              ...
              <div class="col-lg-1 col-sm-2 col-xs-2 chazhaojz">
                <select name="selectway" style="width: 120%; margin-bottom: 3px;">
                  <option selected="selected" value="name">按姓名查找</option>
                  <option value="worknum">按工号查找</option>
                </select>
              </div>
              <div class="col-lg-3 col-sm-3 col-xs-3">
                <input class="form-control11" id="xingming" placeholder="此空选填" value="" name="information"  type="text">
              </div>
              <input class="form-control11" id="xingming" placeholder="此空选填" value="<?php echo $type; ?>" name="type"  type="hidden">
          ...
          <div class="widget-body1">
            ...
            <div class="sc">
             <form class="form-horizontal" role="form" action="__index__/index.php/admin/checkgl/show" method="post" enctype="multipart/form-data">
             ...
             <?php endforeach; endif; else: echo "" ;endif; ?>
              ...
              <h1><b>选取被投票干部名单</b></h1>
                ...
                <tr>
                  ...
                  <td style="text-align:left; ">&nbsp;&nbsp;<?php echo $art['job']; ?></td>
...
// $(function(){
  ...
  //$el.hDialog(); //默认调用
  //定时关闭
  $('.demo17').hDialog({width:300,height: 150,hideTime: 40000, modalHide: false,closeHide: false});
