<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:99:"/Applications/XAMPP/xamppfiles/htdocs/ut-lygbgl/public/../application/admin/view/checkgl/check1.htm";i:1524117003;s:95:"/Applications/XAMPP/xamppfiles/htdocs/ut-lygbgl/public/../application/admin/view/public/top.htm";i:1524117020;s:96:"/Applications/XAMPP/xamppfiles/htdocs/ut-lygbgl/public/../application/admin/view/public/left.htm";i:1524117019;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<!-- /Page Sidebar --> 
  ...
  <div class="tpl-content-wrapper"> 
    ...
    <div class="row">
      <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget1">  
        <div class="widget-header bordered-bottom bordered-blue"> <span class="widget-caption">查看部门名单</span> </div>       
          <div class="widget-body1">
            <div id="horizontal-form">
              <table class="table table-bordered  table-hover table-condensed text-center">
              <caption class="biaotoubiaoti"><?php echo $artres["0"]["checkname"]; ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $artres["0"]["timestart"]; ?>&nbsp;&nbsp;<?php echo $artres["0"]["timeend"]; ?></caption>
                <thead>
                  <tr>
                    <th>部门</th>
                  </tr>
              ...
              <div class="fanhui"><a href="<?php echo url('checkgl/lst'); ?>" class="btn btn-default">返回</a></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- /Page Content --> 
    ...
    <div class="row">
      <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget1"> 
        <div class="widget-header bordered-bottom bordered-blue"> <span class="widget-caption">查看干部考核名单</span> </div>        
          <div class="widget-body1">
            <div id="horizontal-form">
              <table class="table table-bordered  table-hover table-condensed text-center">
              <caption class="biaotoubiaoti"><?php echo $artres["0"]["checkname"]; ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $artres["0"]["timestart"]; ?>&nbsp;&nbsp;<?php echo $artres["0"]["timeend"]; ?></caption>
                ...
                <tr>
                  ...
                  <td><a href="#"><?php echo $art['name']; ?></a></td>
                 
                  <td><?php echo $art['job']; ?></td>
                  <td><?php echo $art["type"]; ?></td>
                  <td><a href="<?php echo url('dec1',array('worknum'=>$art['worknum'],'sumid'=>$art['sumid'])); ?>" class="btn btn-danger btn-sm shiny">
