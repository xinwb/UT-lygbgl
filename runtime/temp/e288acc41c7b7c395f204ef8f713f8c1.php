<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:99:"/Applications/XAMPP/xamppfiles/htdocs/ut-lygbgl/public/../application/admin/view/article/mysort.htm";i:1524116985;s:95:"/Applications/XAMPP/xamppfiles/htdocs/ut-lygbgl/public/../application/admin/view/public/top.htm";i:1524117020;s:96:"/Applications/XAMPP/xamppfiles/htdocs/ut-lygbgl/public/../application/admin/view/public/left.htm";i:1524117019;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
    ...
    <div class="row">
      <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget1">
             ...
             <div class="widget-header bordered-bottom bordered-blue"> <span class="widget-caption">干部信息排序</span> </div>

          <div class="widget-body1">
           <form class="form-horizontal" role="form" action="__index__/index.php/admin/Article/my1" method="post" enctype="multipart/form-data">
            ...
            <div id="horizontal-form">
             <form action="__index__/index.php/admin/Article/mysort" method="post">
              <table class="table table-bordered  table-hover table-condensed text-center">
                <thead>
                  <tr>
                    <th width="5%"><input class="btn btn-default shiny" type="submit" value="排序"></th>
                    <th width="10%">工号</th>
                    <th width="10%">姓名</th>
                    <th width="12%">生日</th>
                ...
                <tr>
                    <label>
                  <td align="center"><input name="<?php echo $art['id']; ?>" type="text" style="width:50px; text-align:center;" value="<?php echo $art['sort']; ?>"></td>
